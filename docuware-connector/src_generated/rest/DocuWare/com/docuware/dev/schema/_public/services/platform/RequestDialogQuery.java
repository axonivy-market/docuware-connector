 ...
 * 
 * &lt;p&gt;Java class for RequestDialogQuery complex type&lt;/p&gt;.
 * 
...
public class RequestDialogQuery {
     ...
     * This is why there is not a {@code set} method for the dialogTypes property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the dialogTypes property.
     */
    public List<DialogTypes> getDialogTypes() {
        if (dialogTypes == null) {
            dialogTypes = new ArrayList<>();
        }
