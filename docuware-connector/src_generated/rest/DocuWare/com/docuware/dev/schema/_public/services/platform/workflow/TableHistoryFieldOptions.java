...
/**
 * <p>Java class for TableHistoryFieldOptions complex type.
 * 
...
public class TableHistoryFieldOptions {
     ...
     * This is why there is not a <CODE>set</CODE> method for the tableColumnsDefinitions property.
     * 
     * <p>
    ...
    public List<TableColumnsDefinition> getTableColumnsDefinitions() {
        if (tableColumnsDefinitions == null) {
            tableColumnsDefinitions = new ArrayList<TableColumnsDefinition>();
        }
