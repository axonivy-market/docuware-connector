 ...
 * 
 * &lt;p&gt;Java class for WebFormListOptions complex type&lt;/p&gt;.
 * 
...
public class WebFormListOptions {
     ...
     * This is why there is not a {@code set} method for the webFormListOption property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the webFormListOption property.
     */
    public List<String> getWebFormListOption() {
        if (webFormListOption == null) {
            webFormListOption = new ArrayList<>();
        }
