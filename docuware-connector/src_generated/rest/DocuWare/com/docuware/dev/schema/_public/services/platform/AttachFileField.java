...
/**
 * &lt;p&gt;Java class for AttachFileField complex type&lt;/p&gt;.
 * 
    ...
    extends WebFormField
{
     ...
     * This is why there is not a {@code set} method for the attachFileInfos property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the attachFileInfos property.
     */
    public List<AttachFileInfo> getAttachFileInfos() {
        if (attachFileInfos == null) {
            attachFileInfos = new ArrayList<>();
        }
