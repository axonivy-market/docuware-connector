...
public class DocuWareAnnotationUpdate {
     ...
     */
    public static DocuWareAnnotationUpdate ofStamp(int pageNumber, int sectionNumber,
                                                   String stampId, int layer,
                                                   String fieldName, String itemValue) {
        DocuWareAnnotationUpdate request = new DocuWareAnnotationUpdate();
        request.setAnnotations(List.of(
                Annotation.of(pageNumber, sectionNumber,
                        AnnotationsPlacement.of(
                                StampPlacement.of(stampId, layer,
                                        StampField.of(fieldName, TypedValue.ofString(itemValue)))))));
        return request;
    }
	...
	public static DocuWareAnnotationUpdate ofStamp(int pageNumber, int sectionNumber, String stampId, int layer,
		...
		DocuWareAnnotationUpdate request = new DocuWareAnnotationUpdate();
		request.setAnnotations(List.of(Annotation.of(pageNumber, sectionNumber,
				AnnotationsPlacement.of(StampPlacement.of(stampId, layer, fields)))));
		return request;
	}
    ...
    public static class Annotation {
        ...
        public AnnotationsPlacement getAnnotationsPlacement() { return annotationsPlacement; }
        public void setAnnotationsPlacement(AnnotationsPlacement annotationsPlacement) { this.annotationsPlacement = annotationsPlacement; }
    ...
    public static class AnnotationsPlacement {
        ...
        public List<StampPlacement> getItems() { return items; }
        public void setItems(List<StampPlacement> items) { this.items = items; }
    ...
    public static class StampPlacement {
        ...
        public List<StampField> getField() { return field; }
        public void setField(List<StampField> field) { this.field = field; }
    ...
    public static class StampField {
        ...
        public TypedValue getTypedValue() { return typedValue; }
        public void setTypedValue(TypedValue typedValue) { this.typedValue = typedValue; }
    ...
    public static class TypedValue {
        ...
        public String getItemElementName() { return itemElementName; }
        public void setItemElementName(String itemElementName) { this.itemElementName = itemElementName; }
